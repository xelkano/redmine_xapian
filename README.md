...
The current version of Redmine Xapian is **2.0.1** [![CI status](https://github.com/xelkano/redmine_xapian/workflows/CI/badge.svg?branch=features)](https://github.com/xelkano/redmine_xapian/actions)
