...
You can run this SQL statement in your database for setting up a default identifier for your repositories:

<pre>
mysql> UDATE repositories SET identifier = 'main' WHERE identifier IS NULL;
</pre>
