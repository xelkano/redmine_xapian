...
To perform attachment searches view_attachment and view_document permissions are necessary,be sure that are both checked. view_attachment permission is necesary because search controller looks for it to draw “files” checkbox on search screen.
