...
The current version of Redmine Xapian is **1.6.3** [![Build Status](https://api.travis-ci.org/picman/redmine_xapian.png)](https://travis-ci.org/picman/redmine_xapian)
